...
const ClientsReview = () => {
    return (
        <div className="flex flex-col px-60 sm:px-10 py-28 gap-20">
            ...
            <div className="flex sm:flex-col gap-40 sm:gap-20">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex gap-52 sm:gap-24">
                        ...
                        <div className="font-poppins sm:pl-2 text-[0.7rem] sm:text-[0.6rem] font-medium w-[8rem] sm:w-w-1/3 leading-[1.2rem] sm:leading-3 tracking-wide">
