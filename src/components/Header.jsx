...
const Header = () => {
    return (
        <div className="flex items-center bg-[#101010] w-[85rem] sm:w-[23rem] 2xl:w-[109rem] xl:w-[69rem] rounded-[2.5rem] sm:rounded-[1.7rem] mt-10 sm:mt-7 justify-between mx-20 sm:mx-3 px-10 sm:px-5">
            <div>
