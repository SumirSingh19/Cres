...
const OurClients = () => {
    return (
        <div className="px-60 2xl:px-32 xl:px-28 sm:px-10 py-20">
            <div className="flex flex-col gap-5 sm:gap-2 pb-10">
                <span className="font-inter uppercase text-xs sm:text-[0.6rem] 2xl:text-base font-semibold">We made design for</span>
                <span className="text-5xl 2xl:text-6xl sm:text-3xl font-bold font-inter">Our clients</span>
                <span className="font-inter text-[0.6rem] 2xl:text-sm sm:text-[0.55rem] w-1/4 sm:w-full">
            ...
            <div className="flex gap-80 sm:gap-20 sm:flex-col">
                <div className="flex flex-col gap-40 2xl:gap-60 sm:gap-24">
                    <div className="flex gap-40 2xl:gap-64 sm:gap-28">
                        <img src={PHOTO2} className="w-[6rem] 2xl:w-[9rem]" alt="" />
                        <img src={PHOTO3} className="w-[5rem] 2xl:w-[8rem]" alt="" />
                    </div>
                    <div className="flex gap-40 2xl:gap-72 sm:gap-32">
                        <img src={PHOTO4} className="w-[5.5rem] 2xl:w-[8rem]" alt="" />
                        <img src={PHOTO1} className="w-[4.5rem] h-[4.5rem] 2xl:w-[8rem] 2xl:h-[6rem]" alt="" />
                    </div>
                </div>
                <div className="w-2/6 xl:w-5/6 sm:w-full flex flex-col gap-6">
                    <div className="flex flex-col gap-5 sm:gap-2">
                        <div className="text-3xl 2xl:text-4xl sm:text-xl font-bold font-inter">
                            <span>Business domains</span>
                        </div>
                        <div className="text-[0.8rem] 2xl:text-[1rem] sm:text-[0.6rem] sm:pr-3">
                            <span>
                    ...
                    <div>
                        <ul className="flex flex-wrap uppercase gap-2 text-[0.55rem] 2xl:text-[0.7rem] font-medium 2xl:font-semibold">
